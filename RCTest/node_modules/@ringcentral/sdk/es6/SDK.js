...
export { Cache, Externals, EventEmitter, };
...
var SDK = /** @class */ (function () {
    function SDK(options) {
        ...
        this._externals = new Externals(__assign({}, defaultExternals, options));
        ...
        this._platform = new Platform(__assign({}, options, { externals: this._externals, client: this._client, cache: this._cache, handleRateLimit: handleRateLimit }));
    }
